...
class IdCard extends StatelessWidget {
  const IdCard(
      ...
      this.subjectImage,
      // this.subjectImage =
      //     const AssetImage("assets/images/user.png", package: "id_wallet_design"),
      this.backgroundImage,
      // this.backgroundImage = const AssetImage("assets/images/haus1.jpg",
      //     package: "id_wallet_design"),
      // this.issuerIcon =
      //     const AssetImage("assets/icons/hsmw.png", package: "id_wallet_design"),
      this.issuerIcon,
